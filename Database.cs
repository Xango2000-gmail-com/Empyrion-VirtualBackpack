...
namespace VirtualBackpack
{
    class DB
    {
        ...
        //static SQLiteConnection sqliteCon = new SQLiteConnection(@"Data Source=..\\Saves\\Games\\" + MyEmpyrionMod.SetupYamlData.General.SaveGameName + "\\global.db");
        //static string dbPath = MyEmpyrionMod.SaveGamePath + "\\global.db";
        //static SQLiteConnection sqliteCon = new SQLiteConnection(@"Data Source=" + dbPath);
        static SQLiteConnection sqliteCon = new SQLiteConnection(@"Data Source=..\\Saves\\Games\\" + MyEmpyrionMod.SaveGameName + "\\global.db");
